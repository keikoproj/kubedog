...
func (kdt *Test) Run() {
	...
	kdt.scenarioContext.Step(`^(?:I )?(create|submit|delete|update) (?:the )?resources in (\S+) in (?:the )?([^"]*) namespace$`, kdt.KubeContext.ResourcesOperationInNamespace)
	...
	//syntax-generation:subtitle: Structured Resources
	//syntax-generation:sub-subtitle: Pods
	...
	//syntax-generation:sub-subtitle: Other Structured Resources
